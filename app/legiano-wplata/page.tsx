...
export default function LegianoWplata() {
  return (
    <div className="min-h-screen relative text-white font-sans flex flex-col items-center justify-center p-8">
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <div className="max-w-2xl w-full mx-auto bg-[#18181b] rounded-2xl p-8 shadow-lg border border-[#a8002f]/60 mb-8 flex flex-col gap-8">
          <h1 className="text-2xl font-extrabold ">Jak wpłacić pieniądze na kasyno Legiano?</h1>
          <p className="text-lg text-gray-200 mb-4">
            <span className="font-bold">Zarejestruj się</span> lub <span className="font-bold">zaloguj</span> na swoje konto w kasynie Legiano.<br/>
            Korzystając z linku do rejestracji (<a href="https://lgno.monvaki.com/?mid=267041_1574918" className="text-theme-red">Kliknij, aby się zarejestrować.</a>), otrzymasz bonus powitalny do wpłaty.
          </p>
          <img src="logowanie-legiano.webp" alt="Logowanie Legiano" className="rounded-2xl mb-6 mx-auto max-w-full" />
          <p className="text-lg text-gray-200 mb-4">
            Następnie kliknij zielony przycisk <span className="font-bold">depozytu</span>.
          </p>
          <img src="wplata-legiano.webp" alt="Depozyt Legiano" className="rounded-2xl mb-6 mx-auto max-w-full"/>
          <p className="text-lg text-gray-200 mb-4">
            Wpisz kwotę (min. 80zł BLIK lub min. 50zł kartą), wybierz preferowaną metodę płatności (np. BLIK, karta, przelew, portfele elektroniczne), a na końcu kliknij <span className="font-bold">zielony przycisk depozytu</span>, aby potwierdzić transakcję.
          </p>
          <img src="platnosc-legiano.webp" alt="Płatność Legiano" className="rounded-2xl mb-6 mx-auto max-w-full"/>
